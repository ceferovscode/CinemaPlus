...
public enum PUCoverFlowLayoutSpacingMode {
    case fixed(spacing: CGFloat)
    case overlap(visibleOffset: CGFloat)
}

open class PUCoverFlowLayout: UICollectionViewFlowLayout {
    ...
    open var spacingMode = PUCoverFlowLayoutSpacingMode.fixed(spacing: 40)
